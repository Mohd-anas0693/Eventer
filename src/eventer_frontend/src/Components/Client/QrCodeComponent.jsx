...
const QrCodeComponent = () => {
    ...
    const approveToMakeAHexcode = async (val) => {
        await backendActor.changeQrGenerateStatus(val);
    }
                ...
                <div className='w-3/4 flex lg:gap-4 flex-col lg:flex-row'>
                    <div className="items-start justify-center pr-8 py-16 flex lg:w-3/5">
                        <div className='flex flex-col'>
                            <p className='text-[#333] text-4xl font-bold'>Event QR Generation</p>
                            <p className='text-gray-600 my-4 font-normal'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam ea dolorum omnis voluptatum, dolor eius debitis aut pariatur in! Amet, magni officia? Possimus nulla earum eaque explicabo fugiat voluptas perspiciatis.</p>
                        </div>
                    </div>
                    <div className="w-full lg:w-2/5 h-full mt-2 flex items-start justify-start">
                        <div className="bg-white px-8 py-7 rounded-xl w-full lg:w-[600px] mb-2 mt-2 my-16 shadow-lg shadow-blue-300">
                            <div className='flex flex-col items-center justify-center'>
                                <span className='my-2 text-blue-900 font-extrabold text-xl cursor-pointer  underline decoration-2 underline-offset-4'>QR Generated</span>
